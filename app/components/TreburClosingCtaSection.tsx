...
const regions: { label: string; href: string }[] = [
  ...
  { label: 'Astheim', href: '/webdesign/trebur' },
  { label: 'Geinsheim', href: '/webdesign/trebur' },
  { label: 'Groß-Gerau', href: '/kontakt' },
  { label: 'Rüsselsheim', href: '/kontakt' },
...
const trustPoints = [
  {
    icon: User,
    text: 'Persönlicher Ansprechpartner vor Ort',
  },
  {
    icon: MapPin,
    text: 'Fokus auf Trebur & Rhein-Main',
  },
  {
    icon: MessageCircle,
...
export default function TreburClosingCtaSection() {
  const reduceMotion = useReduceMotion()

  return (
    <section
      className="relative overflow-hidden bg-white px-6 py-20 md:py-28"
      aria-labelledby="trebur-closing-cta-heading"
    >
      <div className="relative mx-auto max-w-7xl">
        <div className="grid grid-cols-1 items-start gap-14 lg:grid-cols-2 lg:gap-16 xl:gap-20">
          <motion.div className="min-w-0" {...(!reduceMotion ? fadeIn : {})}>
            ...
            >
              Lassen Sie uns gemeinsam Ihre neue Website entwickeln.
            </h2>

            <p className="mt-6 max-w-xl text-base leading-relaxed text-slate-600 md:text-lg md:leading-relaxed">
              Als Webdesigner aus <strong className="font-semibold text-slate-800">Trebur</strong>{' '}
              betreue ich Unternehmen in der gesamten Region persönlich. Kurze Wege, direkte
              Kommunikation und moderne Websites mit Fokus auf{' '}
            ...
            <p className="mt-10 text-sm text-slate-500">
              ...
              <span className="text-slate-400"> — und wie die Zusammenarbeit abläuft.</span>
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-xl font-semibold leading-snug tracking-tight text-slate-900 md:text-2xl md:leading-snug">
                  Bereit für eine Website, die in Trebur und Umgebung{' '}
                  <span className="text-blue-700">gefunden wird</span> und{' '}
                  <span className="text-blue-700">Anfragen</span> bringt?
                </p>
                ...
                <div className="mt-10 flex flex-col gap-3">
                  ...
                  <Link
                    href="/kontakt"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-slate-300 bg-white px-6 py-3.5 text-base font-semibold text-slate-800 transition-colors hover:border-blue-400 hover:text-blue-700"
                  >
                    Website-Check
                  </Link>
