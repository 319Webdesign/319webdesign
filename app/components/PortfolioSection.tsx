                    ...
                    <CardLink {...cardLinkProps}>
                      ...
                      <div className="relative aspect-[16/10] md:aspect-[16/9] overflow-hidden bg-slate-200">
                        <Image
                          ...
                          alt={`Webdesign für KMU in Darmstadt und Pfungstadt – ${project.title} Portfolio ${project.category} von 319Webdesign`}
                          fill
