...
/**
 * FAQ nur /webdesign/pfungstadt – eine H2, Fragen ohne H-Tags (details/summary).
 */
export default function PfungstadtWebdesignFaqSection() {
  return (
    <section
      className="border-t border-slate-200 bg-slate-50 px-6 py-16 md:py-20"
      aria-labelledby="pfungstadt-webdesign-faq-heading"
    >
      <div className="mx-auto max-w-3xl">
        <h2
          id="pfungstadt-webdesign-faq-heading"
          className="mb-10 text-center text-3xl font-bold leading-tight text-slate-900 md:text-4xl"
        >
          Häufige Fragen zu Webdesign in Pfungstadt
        </h2>

        <div className="space-y-3">
          {pfungstadtWebdesignFaqItems.map((item, index) => (
            <details
              key={index}
