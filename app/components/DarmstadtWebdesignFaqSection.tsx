...
/**
 * FAQ nur /webdesign/darmstadt – eine H2, Fragen ohne H-Tags (details/summary).
 */
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl">
        <h2
          id="darmstadt-webdesign-faq-heading"
          className="mb-10 text-center text-3xl font-bold leading-tight text-slate-900 md:text-4xl"
        >
          Häufige Fragen zu Webdesign in Darmstadt
        </h2>

        <div className="space-y-3">
          {darmstadtWebdesignFaqItems.map((item, index) => (
            <details
              key={index}
